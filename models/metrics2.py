...
def run_metrics2(sent_work_rel_dict, work_sent_rel_dict, sent_rel_dict, open_ended_task=False, max_delta = 0.001):
    ...
    while max_delta >= 0.001:
        ...
        for worker_id in work_sent_rel_dict:
            wwa_new[worker_id] = worker_worker_agreement(worker_id, work_sent_rel_dict, sent_work_rel_dict,
                                                         wqs_list[len(wqs_list) - 1],
                                                         sqs_list[len(sqs_list) - 1],
                                                         rqs_list[len(rqs_list) - 1])
            wsa_new[worker_id] = worker_sentence_agreement(worker_id, sent_rel_dict, work_sent_rel_dict,
                                                           sqs_list[len(sqs_list) - 1],
                                                           rqs_list[len(rqs_list) - 1])
    ...
    if not open_ended_task:
        return sqs_list, wqs_list, rqs_list
    return sqs_list, wqs_list, _
