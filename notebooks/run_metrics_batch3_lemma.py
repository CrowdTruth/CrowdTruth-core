...
def do_stuff():
    ...
    sortWQS.to_csv("Results/all_batch3_workers_withAnnotationQuality_lemma.csv", index=False)
    sortAQS.to_csv("Results/all_batch3_annotations_withAnnotationQuality_lemma.csv", index=False)
    ...
    with open('Results/all_batch3_results_withAnnotationQuality_lemma.csv', 'w') as csvfile:
